...
import { motion, AnimatePresence, animate, delay, scale} from 'framer-motion'
import Footer from "../components/footer/Footer";
import { listOfLanguages } from "../constants/appConstants";
import { pageHomeVariants, 
        languageSliderVariants,
        homeDescriptionVariants } from "../constants/motionConstants";
    ...
    <motion.section 
        ...
        >
            <div className="home__body">
                <h1 className="home__title">Listen to podcasts <br/>in&nbsp;
                    <AnimatePresence mode="wait">
                        <motion.span className="lang" 
                        key={curLangIndex}
                ...
                <div className="home__description">
                    ...
                    initial={'hidden'}
                    animate={'visible'}
                    transition={{delay: 0.5, duration:0.5, type: 'keyframes', ease: 'easeOut'}}
                ...
                <ul className="home__languages-list">
                    {
                        listOfLanguages.map((language) => {
                            return (<li className="home__languages-item" key={language.language}>
                                        <NavLink className="home__languages-link"
