...
import {helpSecondVariants, helpFirstVariants, pageHelpVariants} from '../constants/motionConstants'

export default function Help( {pageStep} ) {

    return (
        <motion.section className="help container"
        ...
        >
            <motion.div className="help__box"
            ...
            >
                <AnimatePresence>
                    {pageStep >= 1 && (
                        <motion.div className="help__text"
